...
namespace Spinnaker
{
    ...
    */
    ...
    public:
        ...
        /**
         * Description: User Defined Name. This can be used to enter a unique device name. This information is retained over power cycles.
         * Visibility: 
         */
        ...
        /**
         * Description: Device serial number. This string is a unique identifier of the device.
         * Visibility: 
         */
        ...
        /**
         * Description: Additional manufacturer info.
         * Visibility: 
         */
        ...
        /**
         * Description: Enable the black level auto clamping feature which performing dark current compensation.
         * Visibility: 
         */
        ...
        /**
         * Description: Accesses all user flat field offset correction coefficients in a single access. In this version, it supports max 8192 columns.
         * Visibility: 
         */
        GenApi::IRegister &FfcUserOffsetAll;
        ...
        /**
         * Description: Accesses all user flat field gain correction coefficients in a single access. In this version, it supports 8192 columns.
         * Visibility: 
         */
        GenApi::IRegister &FfcUserGainAll;
        ...
        /**
         * Description: Selects the feature User Set to load and make active by default when the device is restarted.
         * Visibility: 
         */
        GenApi::IEnumerationT<UserSetDefaultEnums> &UserSetDefault;

        /**
         * Description: List of features that are saved to user sets.
         * Visibility: 
         */
